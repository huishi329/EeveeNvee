  ...
  async up(queryInterface, Sequelize) {
    ...
    */
    await queryInterface.bulkInsert('SpotImages', [
      ...
      {
        spotId: 6,
        url: 'https://a0.muscache.com/im/pictures/miso/Hosting-43257372/original/b219a7f4-8465-497c-8a47-395ed96c9782.jpeg?im_w=1440',
        preview: true
      },
      {
        spotId: 7,
        url: 'https://a0.muscache.com/im/pictures/prohost-api/Hosting-624018740377905048/original/a8acecf7-5391-424d-9780-8460dbe1bf6b.jpeg?im_w=1440',
        preview: true
      },
      {
        spotId: 8,
