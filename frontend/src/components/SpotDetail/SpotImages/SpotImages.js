...
export default function SpotImages({ images }) {
    return (
        <div className={styles.wrapper}>
            ...
            {images["2"] && <img className={styles.img3} src={images["2"]?.url} alt='spot image'></img>}
            {images["3"] && <img className={styles.img4} src={images["3"]?.url} alt='spot image'></img>}
            {images["4"] && <img className={styles.img5} src={images["4"]?.url} alt='spot image'></img>}
        </div >
    )
}
